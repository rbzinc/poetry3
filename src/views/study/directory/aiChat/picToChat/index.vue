...
// 定义消息的响应式数据
const messages = ref([
  {text: '发送你所需的情感类型，以及图片内容，我将为你生成古诗。', self: false, type: 'text'},
]);
      ...
      <template v-else>
        ...
        >
          ...
          <div v-if="!message.self" class="avatar-container">
            <img :src="'https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg'" alt="AI头像" class="avatar" />
          </div>
          ...
          <div class="config-form">
            ...
            <div class="form-row">
              ...
              <div class="form-item">
                ...
                <el-select v-model="genreValue" placeholder="请选择" size="small" class="form-input">
                  <el-option
                    v-for="item in genre"
                    :key="item.value"
                    :label="item.label"
              ...
              <div class="form-item">
                ...
                <el-select v-model="emotionValue" placeholder="请选择" size="small" class="form-input">
                  <el-option
            ...
            <div class="form-row">
              ...
              <div class="form-item">
                ...
                <el-select v-model="themeValue" placeholder="请选择" size="small" class="form-input">
                  <el-option
                    v-for="item in theme"
                    :key="item.value"
                    :label="item.label"
              ...
              <div class="form-item">
                ...
                <el-input v-model="input" placeholder="请输入标题" size="small" class="form-input" />
              </div>
            </div>
